        ...
        <section id="projects" class="py-20 border-t border-tech-light">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="group bg-tech-gray rounded-lg overflow-hidden transition-all duration-300 hover:translate-y-[-4px] hover:shadow-lg hover:shadow-tech-accent/5">
                    ...
                    <div class="p-6">
                        <h3 class="text-lg font-medium mb-2"><?php echo e($project['title']); ?></h3>
                        <p class="text-tech-muted text-sm mb-4"><?php echo e($project['description']); ?></p>
                        ...
                        <?php $__currentLoopData = $frontendSkills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div>
                                <div class="flex justify-between mb-1">
                                    ...
                                    <span class="text-xs text-tech-muted"><?php echo e($skill['level']); ?>%</span>
                                </div>
        ...
        <footer class="py-8 border-t border-tech-light mt-12">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <div class="mb-4 md:mb-0">
                    <p class="text-tech-muted text-sm">© <?php echo e(date('Y')); ?> Your Name. All rights reserved.</p>
                </div>
