...
<div class="container mx-auto py-6 max-w-7xl">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="<?php echo e(route('first_timers.create')); ?>" class="bg-orange-500 text-white px-4 py-2 rounded border border-orange-700 shadow-sm hover:bg-orange-600">Register First Timer</a>
    </div>
