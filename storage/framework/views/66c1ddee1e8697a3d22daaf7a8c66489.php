...
<body>
<div class="centered">
    <form method="POST" action="<?php echo e(route('login')); ?>" class="glass-card">
        <?php echo csrf_field(); ?>
        <img src="<?php echo e(asset('images/logoo.png')); ?>" alt="Church Logo" class="logo-icon" />
        ...
        <div class="input-group">
            <img src="<?php echo e(asset('images/logoo.png')); ?>" alt="Email Icon" />
            <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus placeholder="Email Address">
        </div>
        <div class="input-group">
            <img src="<?php echo e(asset('images/logoo.png')); ?>" alt="Password Icon" />
